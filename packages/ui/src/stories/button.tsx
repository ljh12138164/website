...
interface ButtonProps {
  /** 根元素的属性 <a target="_blank" href="https://www.radix-ui.com/primitives/docs/components/button#root">参数</a> */
  rootProps?: React.ComponentProps<"button"> &
...
function Button({ rootProps, children }: ButtonProps) {
  return <ButtonRoot {...rootProps}>{children}</ButtonRoot>;
}
